...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(m2m_table_name, (
            ...
            ('placestickers', models.ForeignKey(orm[u'stig.placestickers'], null=False))
        ))
        db.create_unique(m2m_table_name, ['comment_id', 'placestickers_id'])
    ...
    models = {
        u'stig.comment': {
            ...
            'sticker_list': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['stig.PlaceStickers']", 'symmetrical': 'False'}),
