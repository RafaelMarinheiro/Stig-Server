...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'stig_facebookaccesstoken', (
            ...
            ('trust_until', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'stig', ['FacebookAccessToken'])


    def backwards(self, orm):
        # Deleting model 'FacebookAccessToken'
        db.delete_table(u'stig_facebookaccesstoken')
