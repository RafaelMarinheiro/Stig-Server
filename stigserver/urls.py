...
urlpatterns = patterns('',
    ...
    url(r'^places/(?P<place_pk>.+)/comments/$', views.CommentsForPlace.as_view(), name='commentsforplace-list'),
    url(r'^places/(?P<place_pk>.+)/comments/(?P<pk>.+)/$', views.CommentDetail.as_view(), name='commentsforplace-detail'),
)
